...
1. [Установка R и RStudio](-r-rstudio.html)
2. [Структуры данных в R](-r-.html)
3. [Загрузка данных в R](-tsv-csv-excel-google-.html)
4. [Фильтрация строк, выбор и переименование столбцов, пайплайны](-dplyr-.html)
5. [Добавление вычисляемых столбцов в таблицы](-dplyr-mutate-mutate-if-mutate-at-mutate-all.html)
6. [Группировка и агрегация данных](-dplyr-group-by-summarise.html)
7. [Вертикальное и горизонтальное объединение таблиц](-dplyr-join-bind.html)
8. [Оконные функции в R](-r.html)
9. [Вращение таблиц или аналог сводных таблиц R](-tidyr-pivot-longer-pivot-wider.html)
10. [Загрузка данных из JSON файлов в R и преобразование списков в таблицы](-tidyr-unnest-longer-unnest-wider.html)
11. [Простейшая визуализация данных, пакет ggplot2 и функция qplot()](-ggplot2-ggplot2-qplot.html)
12. [Построение графиков в R слой за слоем с помощью ggplot2](-ggplot2-ggplot2.html)
13. [Изменение элементов графиков и применение готовых тем в ggplot2](-ggplot2-ggplot2-ggthemes-ggthemr.html)
